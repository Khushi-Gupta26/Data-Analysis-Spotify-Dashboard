...
## Dashboard :
<a href = "https://github.com/Khushi-Gupta26/Data-Analysis-Spotify-Dashboard/blob/main/Spotify-Index.png">View</a>
...
o	View Distinct Songs and Average Popularity by Year.
o	Trend analysis of Average Popularity & Distinct Songs by Month.
...
o	Provide drill-down to artist-level data (songs, release date, average popularity, average position, duration).
